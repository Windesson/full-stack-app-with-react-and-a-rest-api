...
* the REST API's /api/courses route and rendering a list of courses. Each course needs 
* to link to its respective "Course Detail" screen. This component also renders a link 
